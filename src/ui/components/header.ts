...
export function setupHeader(
  ...
  // Add settings button and view toggle to header controls
  ...
  settingsButton.addEventListener('click', () => {
    // Toggle sidebar tab to settings
    const settingsTab = document.querySelector('.sidebar-tab[data-tab="settings"]');
    if (settingsTab) {
      (settingsTab as HTMLElement).click();
      
      // Also ensure sidebar is visible when settings is clicked
      if (!document.getElementById('sidebar-container')?.classList.contains('visible')) {
